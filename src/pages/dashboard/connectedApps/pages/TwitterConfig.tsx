...
import { ArrowLeft, Settings2, ExternalLink, MessageSquare, Users, TrendingUp, BarChart2 } from 'lucide-react';
      ...
      <div>
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            }`}>X/Twitter Configuration</h1>
            <p className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>
              Manage your X/Twitter integration settings
            </p>
          </div>
        </div>
      </div>
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>
                  Configure your X/Twitter integration
                </p>
              </div>
              <Button
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-sm ${
                    ...
                    Automatically share new content on X/Twitter
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  isSelected={settings.threadCreation}
                  onValueChange={(value) => setSettings({ ...settings, threadCreation: value })}
                  color="success"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  isSelected={settings.engagement}
                  onValueChange={(value) => setSettings({ ...settings, engagement: value })}
                  color="success"
                />
              </div>
