...
import { ArrowLeft, Settings2, ExternalLink, Music, Play, Clock, Users } from 'lucide-react';
      ...
      <div>
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            }`}>Spotify Configuration</h1>
            <p className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>
              Manage your Spotify integration settings
            </p>
          </div>
        </div>
      </div>
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>
                  Configure your Spotify integration
                </p>
              </div>
              <Button
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-sm ${
                    ...
                    Automatically sync podcast playlists
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  isSelected={settings.playlistSync}
                  onValueChange={(value) => setSettings({ ...settings, playlistSync: value })}
                  color="success"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  isSelected={settings.recommendations}
                  onValueChange={(value) => setSettings({ ...settings, recommendations: value })}
                  color="success"
                />
              </div>
