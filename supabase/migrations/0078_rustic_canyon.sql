...
DROP FUNCTION IF EXISTS search_videos(text, text, text);
DROP FUNCTION IF EXISTS search_videos_v2(text, text, text);

-- Create new search function with proper parameters
