...
DROP POLICY IF EXISTS "Users can manage AI insights" ON ai_analysis;
DROP POLICY IF EXISTS "Users can view AI insights" ON ai_analysis;
...
CREATE POLICY "Users can manage transcriptsI'll help fix the issues with video metadata operations and RLS policies. Here are the necessary changes:

<boltArtifact id="fix-video-metadata" title="Fix video metadata operations and RLS policies">
<boltAction type="file" filePath="supabase/migrations/0043_light_snow.sql" contentType="content">-- Drop existing policies
