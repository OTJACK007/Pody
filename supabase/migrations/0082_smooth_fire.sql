...
-- Create indexes
CREATE INDEX idx_knowledge_summaries_category ON knowledge_summaries(category_id);
CREATE INDEX idx_knowledge_summaries_user ON knowledge_summaries(user_id);
CREATE INDEX idx_knowledge_summaries_video ON knowledge_summaries(video_id);
CREATE INDEX idx_knowledge_summaries_tags ON knowledge_summaries USING gin(tags);

CREATE INDEX idx_knowledge_highlights_category ON knowledge_highlights(category_id);
CREATE INDEX idx_knowledge_highlights_user ON knowledge_highlights(user_id);
CREATE INDEX idx_knowledge_highlights_video ON knowledge_highlights(video_id);
CREATE INDEX idx_knowledge_highlights_tags ON knowledge_highlights USING gin(tags);

CREATE INDEX idx_knowledge_topics_category ON knowledge_topics(category_id);
CREATE INDEX idx_knowledge_topics_user ON knowledge_topics(user_id);
CREATE INDEX idx_knowledge_topics_video ON knowledge_topics(video_id);
